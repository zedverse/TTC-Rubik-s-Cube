...
def reset():
    ...
    dlF, dF, drF, lF, F, rF, ulF, uF, urF = [green for _ in range(9)]  # front
    ...
    dlB, dB, drB, lB, B, rB, ulB, uB, urB = [blue for _ in range(9)]  # back
    global Ulf, Uf, Urf, Ul, U, Ur, Ulb, Ub, Urb
    Ulf, Uf, Urf, Ul, U, Ur, Ulb, Ub, Urb = [white for _ in range(9)]  # up
    global Dlb, Db, Drb, Dl, D, Dr, Dlf, Df, Drf
    Dlb, Db, Drb, Dl, D, Dr, Dlf, Df, Drf = [yellow for _ in range(9)]  # down
    drawCube()
    instructions()
